...
<head>
    <title>讨论平台</title>
    <jsp:include page="commom/commonfile.jsp"/>
</head>
<body>
...
<div class="am-cf admin-main" >
    ...
    <!-- content start -->
    <div class="admin-content" style="width: 80%;float:right;">
        <div class="" style="width: 80%;float:left;">
            ...
            <div class="" style="float: left">
                <p class="am-kai">发送给 : <span id="sendto">全体成员</span></p>
            </div>
            <!-- 按钮区 -->
...
<script>
    ...
    function showChat(message){
        ...
        var html = "<li class=\"am-comment "+isSef+" am-comment-primary\"><a href=\"#link-to-user-home\"><img width=\"48\" height=\"48\" class=\"am-comment-avatar\" alt=\"\" src=\"${ctx}/static/image/img.jpeg\"></a><div class=\"am-comment-main\">\n" +
